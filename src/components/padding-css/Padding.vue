<template>
  <div>
    ...
    <div>
      ...
      <div>
        This div element has a top padding of 25px, a right padding of 50px, a
        bottom padding of 75px, and a left padding of 100px.
      </div>
    </div>
    <div>
      ...
      <div>
        This div element has a top padding of 25px, a right and left padding of
        50px, and a bottom padding of 75px.
      </div>
    </div>
    <div>
      <h2>The padding shorthand property - 3 values</h2>
    ...
    <div>
      ...
      <div>
        This div element has a top and bottom padding of 25px, and a right and
        left padding of 50px.
      </div>
    </div>
    <div>
    ...
    <div>
      ...
      <div class="ex2">
        The width of this div is 350px, even though it is defined as 300px in
        the CSS.
      </div>
    </div>
    <div>
